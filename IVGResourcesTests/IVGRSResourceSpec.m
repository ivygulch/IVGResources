...
describe(@"Resource", ^{
    ...
    it(@"should not create resource for invalid temp file", ^{
        NSString *name = @"test1.png";
    ...
    it(@"should find valid files for retina iphone 4", ^{
        NSString *name = @"test1.png";
    ...
    it(@"should find valid files for retina iphone 5", ^{
        NSString *name = @"test1.png";
        NSArray *qualifiers = @[@"",@"-568h@2x~iphone",@"@2x"];
        NSString *tmpDir = [self temporaryFilesWithName:name qualifiers:qualifiers];
        IVGRSResource *resource = [[IVGRSResource alloc] initWithBasePath:tmpDir name:name];
    ...
    it(@"should find valid files for retina iPad", ^{
        NSString *name = @"test1.png";
        NSArray *qualifiers = @[@"",@"-568h@2x~iphone",@"@2x"];
        NSString *tmpDir = [self temporaryFilesWithName:name qualifiers:qualifiers];
        IVGRSResource *resource = [[IVGRSResource alloc] initWithBasePath:tmpDir name:name];
    ...
    it(@"should find valid files in appropriate directory", ^{
